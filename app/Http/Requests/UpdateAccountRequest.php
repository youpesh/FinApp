...
class UpdateAccountRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'account_name' => ['required', 'string', 'max:255', Rule::unique('accounts', 'account_name')->ignore($accountId)],
            'account_number' => ['required', 'integer', 'min:1', Rule::unique('accounts', 'account_number')->ignore($accountId)],

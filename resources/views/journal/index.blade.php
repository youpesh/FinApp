                            ...
                            @forelse($entries as $entry)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @else
                                            <span
                                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-amber-100 text-amber-800">Pending</span>
                                        @endif
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-8 text-center text-gray-500 border-t border-gray-200">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">Try adjusting your search or filter
                                            requirements.</p>
                                    </td>
                                </tr>
                            @endforelse

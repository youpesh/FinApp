                                    ...
                                    @foreach($users as $user)
                                        <tr class="bg-red-50/50  hover:bg-red-50  transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                ...
                                                <span
                                                    class="px-2.5 py-1 rounded-full text-xs font-medium bg-{{ $sc }}-100 text-{{ $sc }}-800 {{ $sc }}-900/40 {{ $sc }}-300 capitalize">
                                                    {{ $user->status }}
                                                </span>
                                            </td>
                                            ...
                                            <td class="px-4 py-3 text-sm text-red-700  font-bold">
                                                {{ (int) abs($user->password_expires_at->diffInDays(now())) }} days
                                            </td>

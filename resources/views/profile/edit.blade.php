        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            @if (session('status') === 'password-expired')
                <div
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-red-800 dark:text-red-200">Your password has expired</h3>
                        <p class="text-sm text-red-700 dark:text-red-300 mt-0.5">Please update your password below to
